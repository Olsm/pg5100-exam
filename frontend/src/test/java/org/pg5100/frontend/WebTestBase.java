...
public class WebTestBase {
    ...
    protected static void createAndLogNewUser(String userId, String name, String email, String city, String country) {
        home.logout();
        LoginPageObject login = home.toLogin();
        CreateUserPageObject create = login.clickCreateNewUser();
        create.createUser(userId, "foo", "foo", name, email, city, country);
        assertTrue(home.isLoggedIn(userId));
    }

    protected static void createPost(String title, String country) {
